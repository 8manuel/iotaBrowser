...
func main() {
	...
	iriUrl := flag.String("iriurl", "http://p101.iotaledger.net:14700", "Iota IRI server:port")                           // NOTE if not works try other from this testnet list.. "http://iota.nessys.es:14700", "https://testnet140.tangle.works:443", "http://p101.iotaledger.net:14700", "http://p103.iotaledger.net:14700"
